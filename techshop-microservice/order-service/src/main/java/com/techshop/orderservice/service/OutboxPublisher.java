...
/**
 * Scheduler đọc các event PENDING trong outbox và publish lên Kafka (Polling Publisher).
 *
    ...
    private void publishSingleEvent(OutboxEvent event) {
        ...
        try {
            ...
            if (newRetryCount >= maxRetries) {
                // Vượt ngưỡng retry → đánh dấu FAILED, cần can thiệp thủ công
                ...
                // Log rõ từng lần retry để dễ theo dõi
